...
var default_deck = CardDataManager.get_deck_from_str_id("tinker")
...
func test_tinker_drill_arm():
	position_players(player1, 2, player2, 1)
	execute_strike(player1, player2, "tinker_drillarm", "standard_normal_sweep", [], [], false, false, [], [], 0, true)
	validate_positions(player1, 2, player2, 1)
	validate_life(player1, 9, player2, 9)

func test_tinker_drill_arm_miss():
	position_players(player1, 4, player2, 1)
	execute_strike(player1, player2, "tinker_drillarm", "standard_normal_sweep", [], [], false, false, [], [], 0, true)
	validate_positions(player1, 4, player2, 1)
	validate_life(player1, 9, player2, 15)

func test_tinker_drill_arm_exceed():
	_setup_tank()

	position_players(player1, 5, player2, 1)
	execute_strike(player1, player2, "tinker_drillarm", "standard_normal_sweep", [], [], false, false, [], [], 0, true)
	validate_positions(player1, 5, player2, 1)
	validate_life(player1, 20, player2, 6)

func test_tinker_flail():
	position_players(player1, 2, player2, 3)
	execute_strike(player1, player2, "tinker_flail", "standard_normal_assault", [], [], false, false)
	validate_positions(player1, 5, player2, 3)
	validate_life(player1, 15, player2, 12)

func test_tinker_flail_stunned():
	position_players(player1, 3, player2, 4)
	# pull 1
	execute_strike(player1, player2, "tinker_flail", "standard_normal_grasp", [], [2], false, false)
	validate_positions(player1, 5, player2, 4)
	validate_life(player1, 12, player2, 15)

func test_tinker_flail_exceed():
	_setup_tank()
...
func test_tinker_missiles():
	position_players(player1, 2, player2, 5)
	# push 2
	execute_strike(player1, player2, "tinker_missiles", "standard_normal_sweep", [1], [], false, false)
	validate_positions(player1, 2, player2, 7)
	validate_life(player1, 15, player2, 11)

func test_tinker_missiles_exceed():
	_setup_tank()

	position_players(player1, 2, player2, 7)
	execute_strike(player1, player2, "tinker_missiles", "standard_normal_sweep", [], [], false, false, [])
	assert_true(game_logic.do_force_for_effect(player1, [player1.hand[0].id, player1.hand[1].id], false))
	assert_true(game_logic.do_choice(player1, 3)) # pull 2
	validate_positions(player1, 2, player2, 5)
	validate_life(player1, 15, player2, 9)

func test_tinker_mobilegear():
	position_players(player1, 2, player2, 6)
	execute_strike(player1, player2, "tinker_mobilegear", "standard_normal_assault", [], [], false, false)
	validate_positions(player1, 5, player2, 6)
	validate_life(player1, 15, player2, 12)

func test_tinker_mobilegear_miss():
	position_players(player1, 2, player2, 4)
	execute_strike(player1, player2, "tinker_mobilegear", "standard_normal_assault", [], [], false, false)
	validate_positions(player1, 6, player2, 5)
	validate_life(player1, 11, player2, 15)

func test_tinker_mobilegear_exceed():
	_setup_tank()
...
func test_tinker_wrenchtoss():
	position_players(player1, 3, player2, 6)
	execute_strike(player1, player2, "tinker_wrenchtoss", "standard_normal_dive", [], [], false, false)
	validate_positions(player1, 3, player2, 7)
	validate_life(player1, 15, player2, 13)

func test_tinker_wrenchtoss_outsped():
	position_players(player1, 3, player2, 6)
	execute_strike(player1, player2, "tinker_wrenchtoss", "standard_normal_assault", [], [], false, false)
	validate_positions(player1, 3, player2, 4)
	validate_life(player1, 11, player2, 15)

func test_tinker_wrenchtoss_exceed():
	_setup_tank()

	position_players(player1, 2, player2, 7)
	execute_strike(player1, player2, "tinker_wrenchtoss", "standard_normal_assault", [], [], false, false)
	validate_positions(player1, 4, player2, 8)
	validate_life(player1, 20, player2, 11)

func test_tinker_bombbounce():
	give_gauge(player1, 3)
	position_players(player1, 3, player2, 6)
	execute_strike(player1, player2, "tinker_bombbounce", "standard_normal_focus", [], [], false, false)
	validate_positions(player1, 3, player2, 6)
	validate_life(player1, 15, player2, 9)

func test_tinker_bombbounce_no_ig():
	give_gauge(player1, 3)
	position_players(player1, 3, player2, 6)
	execute_strike(player1, player2, "tinker_bombbounce", "standard_normal_sweep", [], [], false, false)
	validate_positions(player1, 3, player2, 6)
	validate_life(player1, 9, player2, 9)

func test_tinker_bombbounce_stunned():
	give_gauge(player1, 3)
	position_players(player1, 3, player2, 6)
	execute_strike(player1, player2, "tinker_bombbounce", "standard_normal_sweep", [], [], false, true)
	validate_positions(player1, 3, player2, 6)
	validate_life(player1, 8, player2, 15)

func test_tinker_bombbounce_exceed_stun_immune():
	_setup_tank()
...
func test_tinker_bombbounce_exceed_ig():
	_setup_tank()

	position_players(player1, 3, player2, 6)
	execute_strike(player1, player2, "tinker_bombbounce", "standard_normal_sweep", [], [], false, false)
	validate_positions(player1, 3, player2, 6)
	validate_life(player1, 20, player2, 9)

func test_tinker_mechcharge():
	give_gauge(player1, 3)
	position_players(player1, 4, player2, 6)
	execute_strike(player1, player2, "tinker_mechcharge", "standard_normal_sweep", [], [], false, false)
	validate_positions(player1, 8, player2, 9)
	validate_life(player1, 9, player2, 12)

func test_tinker_mechcharge_exceed():
	_setup_tank()
	...
	validate_life(player1, 20, player2, 8)

func test_tinker_within_my_reach_ignore_cost():
	give_player_specific_card(player1, "tinker_bombbounce", TestCardId3)
	give_player_specific_card(player1, "tinker_flail", TestCardId4)
...
func test_tinker_within_my_reach_no_boosts():
...
func test_tinker_within_my_reach_exceed():
	_setup_tank()
