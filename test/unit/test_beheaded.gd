...
var default_deck = CardDefinitions.get_deck_from_str_id("beheaded")
...
func test_beheaded_exceed_no_more_traits():
	position_players(player1, 3, player2, 7)
	give_gauge(player1, 2)
	player1.set_aside_cards = []
...
func test_beheaded_assault_shield_not_hit():
	...
	execute_strike(player1, player2, "beheaded_assaultshield", "standard_normal_grasp", [], [], false, false)
	validate_positions(player1, 5, player2, 6)
	validate_life(player1, 30, player2, 29)
	advance_turn(player2)

func test_beheaded_assault_shield_hit():
	position_players(player1, 3, player2, 6)

	execute_strike(player1, player2, "beheaded_assaultshield", "standard_normal_assault", [], [], false, false)
	validate_positions(player1, 3, player2, 4)
	validate_life(player1, 28, player2, 27)
	advance_turn(player2)

func test_beheaded_assault_shield_max_guard():
	position_players(player1, 3, player2, 6)
...
func test_beheaded_wolf_trap_remove_action():
	position_players(player1, 3, player2, 6)
	give_player_specific_card(player1, "beheaded_twindaggers", TestCardId3)
...
func test_beheaded_phaser_no_damage():
	position_players(player1, 8, player2, 2)
	give_gauge(player1, 3)
	var trait_id = -1
	for card in player1.set_aside_cards:
		if card.definition['id'] == "beheaded_trait_brutality":
			trait_id = card.id
			break
	...
	execute_strike(player1, player2, "beheaded_phaser", "standard_normal_grasp", [], [], false, false)
