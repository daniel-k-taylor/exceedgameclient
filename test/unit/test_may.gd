...
var default_deck = CardDefinitions.get_deck_from_str_id("may")
...
func test_may_yamada_boost_spend():
	position_players(player1, 3, player2, 8)
	give_player_specific_card(player1, "may_yamada", TestCardId3)
...
func test_may_yamada_boost_pass():
	position_players(player1, 3, player2, 8)
	give_player_specific_card(player1, "may_yamada", TestCardId3)
	assert_true(game_logic.do_boost(player1, TestCardId3))
	validate_positions(player1, 6, player2, 8)
	...
	assert_eq(player2.my_id, game_logic.active_turn_player)

func test_arisugawa_boost():
	give_player_specific_card(player1, "may_arisugawasparkle", TestCardId3)
	assert_eq(player1.hand.size(), 6)
	var card_ids = []
