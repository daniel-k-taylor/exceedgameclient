...
var default_deck = CardDataManager.get_deck_from_str_id("phonon")
...
func test_phonon_guidance_no_power():
	position_players(player1, 3, player2, 6)
	execute_strike(player1, player2, "phonon_guidanceascension", "phonon_guidanceascension", [], [], false, false, [], [], 0, [])
	validate_positions(player1, 3, player2, 6)
	validate_life(player1, 30, player2, 30)

func test_phonon_guidance_ua():
	position_players(player1, 3, player2, 6)
	...
	assert_true(game_logic.do_character_action(player2, [], 0))
	execute_strike(player2, player1, "phonon_guidanceascension", "phonon_guidanceascension", [], [], false, false, [], [], 0, [])
...
func test_phonon_turning_reveal_copy_gainadv():
	position_players(player1, 3, player2, 6)
	give_player_specific_card(player1, "phonon_turningsatisfaction", TestCardId3)
	execute_strike(player1, player2, "phonon_turningsatisfaction", "phonon_turningsatisfaction", [0], [], false, false, [], [], 0, [])
	validate_positions(player1, 3, player2, 7)
	validate_life(player1, 30, player2, 28)
	assert_eq(game_logic.active_turn_player, player1.my_id)

func test_phonon_sliding_boost_return():
	position_players(player1, 3, player2, 4)
	give_player_specific_card(player1, "phonon_slidingaffliction", TestCardId3)
	assert_true(game_logic.do_boost(player1, TestCardId3))
	advance_turn(player2)
	execute_strike(player1, player2, "phonon_turningsatisfaction", "uni_normal_cross", [0, 0], [], false, false, [], [], 0, [])
	validate_positions(player1, 3, player2, 5)
	validate_life(player1, 30, player2, 28)
	assert_true(player1.is_card_in_hand(TestCardId3))

func test_phonon_sliding_boost_return_power_loss():
	position_players(player1, 3, player2, 4)
	give_player_specific_card(player1, "phonon_slidingaffliction", TestCardId3)
	assert_true(game_logic.do_boost(player1, TestCardId3))
	execute_strike(player2, player1, "uni_normal_dive", "phonon_turningsatisfaction", [], [0, 0], false, false, [], [], 0, [])
	validate_positions(player1, 3, player2, 5)
	validate_life(player1, 30, player2, 28)
	assert_true(player1.is_card_in_hand(TestCardId3))

func test_phonon_suppressive_after():
	position_players(player1, 3, player2, 7)
	assert_eq(player1.hand.size(), 5)
	assert_true(game_logic.do_character_action(player1, [], 0))
	execute_strike(player1, player2, "phonon_suppressiverestriction", "uni_normal_assault", [0], [], false, false, [], [], 0, [])
	validate_positions(player1, 3, player2, 8)
	validate_life(player1, 30, player2, 27)
	assert_eq(player1.hand.size(), 7)

func test_phonon_completeservitude_strike():
	position_players(player1, 3, player2, 8)
	give_gauge(player1, 3)
	assert_true(game_logic.do_character_action(player1, [], 0))
	execute_strike(player1, player2, "phonon_completeservitude", "uni_normal_grasp", [], [], false, false, [], [], 0, [])
	validate_positions(player1, 3, player2, 8)
	validate_life(player1, 30, player2, 23)

func test_phonon_completeservitude_boost():
	position_players(player1, 3, player2, 5)
	give_player_specific_card(player1, "phonon_completeservitude", TestCardId3)
	...
	execute_strike(player1, player2, "uni_normal_assault", "uni_normal_grasp", [], [], false, false, [], [], 0, [])
	validate_positions(player1, 4, player2, 5)
	validate_life(player1, 30, player2, 24)

func test_phonon_bindingbeatitude_strike():
	position_players(player1, 3, player2, 8)
	give_gauge(player1, 3)
	assert_true(game_logic.do_character_action(player1, [], 0))
	execute_strike(player1, player2, "phonon_bindingbeatitude", "uni_normal_grasp", [0], [], false, false, [], [], 0, [])
	validate_positions(player1, 3, player2, 8)
	validate_life(player1, 30, player2, 25)
	assert_true(player1.is_card_in_hand(TestCardId1))
	assert_eq(player1.gauge.size(), 1)

func test_phonon_bindingbeatitude_boost():
	position_players(player1, 3, player2, 5)
	give_player_specific_card(player1, "phonon_bindingbeatitude", TestCardId3)
	assert_true(game_logic.do_boost(player1, TestCardId3))
	assert_eq(player1.hand.size(), 7)
	advance_turn(player2)
	execute_strike(player1, player2, "uni_normal_assault", "uni_normal_grasp", [0], [], false, false, [], [], 0, [])
	validate_positions(player1, 4, player2, 5)
	validate_life(player1, 30, player2, 25)
	assert_true(player1.is_card_in_hand(TestCardId3))
