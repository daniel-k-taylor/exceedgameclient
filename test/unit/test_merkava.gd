...
var default_deck = CardDefinitions.get_deck_from_str_id("merkava")
...
func test_merkava_ua():
	position_players(player1, 3, player2, 7)
	give_player_specific_card(player1, "uni_normal_focus", TestCardId3)
	...
	assert_true("uni_normal_focus" in player1.public_hand)
	advance_turn(player2)

func test_merkava_ua_defile():
	position_players(player1, 6, player2, 9)
	give_player_specific_card(player1, "merkava_idefile", TestCardId3)
	player1.move_card_from_hand_to_deck(TestCardId3)
	...
	assert_true("merkava_idefile" in player1.public_hand)
	advance_turn(player2)

func test_merkava_ua_empty_deck():
	position_players(player1, 3, player2, 7)
...
func test_merkava_exceed_ua():
	...
	assert_true(game_logic.do_character_action(player1, []))
	assert_true(game_logic.do_gauge_for_effect(player1, [TestCardId3]))
	assert_true(game_logic.do_choice(player1, 1))

	validate_positions(player1, 2, player2, 7)
	advance_turn(player2)

func test_merkava_persistently_cling_hit():
	position_players(player1, 3, player2, 7)

	give_player_specific_card(player1, "merkava_ipersistentlycling", TestCardId1)
...
func test_merkava_persistently_cling_miss():
...
func test_merkava_defile_range1():
	position_players(player1, 1, player2, 2)
	give_gauge(player1, 1)

	execute_strike(player1, player2, "merkava_idefile", "uni_normal_grasp", [], [], false, false,
		[], [], -7)

	validate_positions(player1, 1, player2, 2)
	validate_life(player1, 30, player2, 29)
	validate_gauge(player1, 1, TestCardId1)
	advance_turn(player2)

func test_merkava_defile_range8():
...
func test_merkava_defile_instantflight():
	position_players(player1, 1, player2, 2)
	give_gauge(player1, 1)

	give_player_specific_card(player1, "merkava_ibreatheout", TestCardId3)
	...
	execute_strike(player1, player2, "merkava_idefile", "uni_normal_grasp", [0], [], false, false,
		[], [], -7)

	validate_positions(player1, 8, player2, 2)
	validate_life(player1, 30, player2, 24)
	validate_gauge(player1, 1, TestCardId1)
	advance_turn(player2)

func test_merkava_dark_bite_redundant():
...
func test_merkava_dark_bite_spike():
	position_players(player1, 3, player2, 4)

	give_player_specific_card(player1, "merkava_idefile", TestCardId3)
	assert_true(game_logic.do_boost(player1, TestCardId3, []))
	execute_strike(player1, player2, "uni_normal_spike", "uni_normal_sweep", [], [], false, false)

	validate_positions(player1, 3, player2, 4)
	validate_life(player1, 30, player2, 25)
	advance_turn(player2)

func test_merkava_dark_bite_persistentlycling_hit():
...
func test_merkava_dark_bite_persistentlycling_miss():
...
func test_merkava_dark_bite_persistentlycling_miss_with_range_boost():
	position_players(player1, 3, player2, 7)

	give_player_specific_card(player1, "merkava_ipersistentlycling", TestCardId4)
...
func test_merkava_resentfully_rage_push_big():
	position_players(player1, 2, player2, 3)
	give_gauge(player1, 3)

	execute_strike(player1, player2, "merkava_iresentfullyrage", "uni_normal_sweep", [0], [], false, false)
...
func test_merkava_resentfully_rage_push_smaller():
	position_players(player1, 2, player2, 5)
	give_gauge(player1, 3)

	execute_strike(player1, player2, "merkava_iresentfullyrage", "uni_normal_sweep", [1], [], false, false)
...
func test_merkava_resentfully_rage_push_wall():
...
func test_merkava_jormungandr_normal():
	position_players(player1, 3, player2, 5)

	give_player_specific_card(player1, "merkava_iresentfullyrage", TestCardId3)
	assert_true(game_logic.do_boost(player1, TestCardId3, []))
	advance_turn(player2)
...
func test_merkava_jormungandr_not_normal():
	...
	execute_strike(player1, player2, "merkava_iagitate", "uni_normal_sweep", [], [], false, false)
