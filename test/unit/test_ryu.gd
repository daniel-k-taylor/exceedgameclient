...
var default_deck = CardDefinitions.get_deck_from_str_id("ryu")
...
func test_ryu_shoryu_defend_miss():
	...
	execute_strike(player1, player2, "standard_normal_cross", "ryu_shoryuken", [], [], false, false,
		[], [], 0, true, true)
...
func test_ryu_shoryu_defend_hit():
	...
	give_gauge(player2, 1)
	execute_strike(player1, player2, "standard_normal_cross", "ryu_shoryuken", [], [], false, false,
		[], [player2.gauge[0].id], 0, true, true)
