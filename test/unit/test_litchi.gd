...
var default_deck = CardDefinitions.get_deck_from_str_id("litchi")
...
func test_litchi_summon_and_move_mantenbo():
	...
	assert_eq(player1.get_buddy_location(), 4)
...
func test_litchi_range_with_mantenbo():
	position_players(player1, 3, player2, 7)
	execute_strike(player1, player2, "standard_normal_assault", "standard_normal_assault", [], [], false, false)
