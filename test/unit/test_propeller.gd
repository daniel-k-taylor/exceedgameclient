...
var default_deck = CardDataManager.get_deck_from_str_id("propeller")
...
func test_propeller_swoop_range_three():
	give_player_specific_card(player1, "standard_normal_spike", TestCardId3)
...
func test_propeller_swoop_not_range_three():
	position_players(player1, 4, player2, 5)
	execute_strike(player1, player2, "propeller_swoop","standard_normal_assault", [1], [], false, false)
