...
var default_deck = CardDataManager.get_deck_from_str_id("byakuya")
...
func test_byakuya_webtrap_basic():
	...
	var webtrap_buddy_id = player1.get_buddy_id_for_boost(TestCardId3)
	assert_eq(player1.get_buddy_location(webtrap_buddy_id), 5)
	assert_true(player1.is_card_in_continuous_boosts(TestCardId3))

	execute_strike(player2, player1, "uni_normal_dive", "uni_normal_sweep", [], [0], false, false)
	validate_positions(player1, 3, player2, 6)
	validate_life(player1, 30, player2, 24)
	assert_false(player1.is_buddy_in_play(webtrap_buddy_id))
	assert_true(player1.is_card_in_discards(TestCardId3))
	advance_turn(player1)

func test_byakuya_webtrap_outside_strike():
	position_players(player1, 3, player2, 6)
	give_player_specific_card(player1, "byakuya_endlessnightmare", TestCardId3)
	...
	give_player_specific_card(player2, "uni_normal_assault", TestCardId4)
...
func test_byakuya_webtrap_self_movement():
	position_players(player1, 3, player2, 1)
	give_player_specific_card(player1, "byakuya_becomeapartofme", TestCardId3)
	...
	execute_strike(player1, player2, "uni_normal_cross", "uni_normal_sweep", [2], [], false, false)
...
func test_byakuya_webtrap_forced_movement():
	...
	var webtrap_buddy_id = player1.get_buddy_id_for_boost(TestCardId3)
	assert_eq(player1.get_buddy_location(webtrap_buddy_id), 6)
	assert_true(player1.is_card_in_continuous_boosts(TestCardId3))
	advance_turn(player2)

	execute_strike(player1, player2, "uni_normal_grasp", "uni_normal_sweep", [1, 0], [], false, false)
...
func test_byakuya_webtrap_start_on_space():
	position_players(player1, 3, player2, 6)
	give_player_specific_card(player1, "byakuya_endlessnightmare", TestCardId3)
...
func test_byakuya_webtrap_end_on_space():
	position_players(player1, 3, player2, 6)
	give_player_specific_card(player1, "byakuya_endlessnightmare", TestCardId3)
	...
	var webtrap_buddy_id = player1.get_buddy_id_for_boost(TestCardId3)
	assert_eq(player1.get_buddy_location(webtrap_buddy_id), 2)
	assert_true(player1.is_card_in_continuous_boosts(TestCardId3))
...
func test_byakuya_webtrap_end_on_space_weird_dive_thing():
	position_players(player1, 3, player2, 6)
	give_player_specific_card(player1, "byakuya_endlessnightmare", TestCardId3)
	...
	execute_strike(player2, player1, "uni_normal_dive", "uni_normal_sweep", [], [1], false, false)
	validate_positions(player1, 3, player2, 4)
	validate_life(player1, 25, player2, 30)
	assert_false(player1.is_buddy_in_play(webtrap_buddy_id))
	assert_true(player1.is_card_in_discards(TestCardId3))
...
func test_byakuya_webtrap_stacked():
	position_players(player1, 3, player2, 6)
	give_player_specific_card(player1, "byakuya_endlessnightmare", TestCardId3)
	give_player_specific_card(player1, "byakuya_becomeapartofme", TestCardId4)
	...
	assert_true(game_logic.do_choice(player1, 4))
	var webtrap_buddy_id2 = player1.get_buddy_id_for_boost(TestCardId4)
	assert_eq(player1.get_buddy_location(webtrap_buddy_id2), 5)
	assert_true(player1.is_card_in_continuous_boosts(TestCardId4))
	advance_turn(player2)

	execute_strike(player1, player2, "uni_normal_sweep", "uni_normal_dive", [0, 2], [], false, false)
	validate_positions(player1, 3, player2, 6)
	validate_life(player1, 30, player2, 24)
	assert_false(player1.is_buddy_in_play(webtrap_buddy_id1))
	assert_true(player1.is_card_in_discards(TestCardId3))
	assert_false(player1.is_buddy_in_play(webtrap_buddy_id2))
	assert_true(player1.is_card_in_discards(TestCardId4))
	advance_turn(player1)

func test_byakuya_webtrap_not_stacked():
	position_players(player1, 3, player2, 6)
	give_player_specific_card(player1, "byakuya_endlessnightmare", TestCardId3)
	give_player_specific_card(player1, "byakuya_becomeapartofme", TestCardId4)
	...
	var webtrap_buddy_id2 = player1.get_buddy_id_for_boost(TestCardId4)
	assert_eq(player1.get_buddy_location(webtrap_buddy_id2), 4)
	assert_true(player1.is_card_in_continuous_boosts(TestCardId4))
	advance_turn(player2)

	execute_strike(player1, player2, "uni_normal_sweep", "uni_normal_dive", [0], [], false, false)
	validate_positions(player1, 3, player2, 6)
	validate_life(player1, 30, player2, 24)
	assert_false(player1.is_buddy_in_play(webtrap_buddy_id1))
	assert_true(player1.is_card_in_discards(TestCardId3))
...
func test_byakuya_webtrap_combo():
	position_players(player1, 3, player2, 6)
	give_player_specific_card(player1, "byakuya_endlessnightmare", TestCardId3)
	give_player_specific_card(player1, "byakuya_becomeapartofme", TestCardId4)
	...
	assert_true(game_logic.do_choice(player1, 5))
	var webtrap_buddy_id2 = player1.get_buddy_id_for_boost(TestCardId4)
	assert_eq(player1.get_buddy_location(webtrap_buddy_id2), 6)
	assert_true(player1.is_card_in_continuous_boosts(TestCardId4))
	advance_turn(player2)

	execute_strike(player1, player2, "uni_normal_sweep", "uni_normal_dive", [0, 0], [], false, false)
	validate_positions(player1, 3, player2, 7)
	validate_life(player1, 30, player2, 30)
	assert_false(player1.is_buddy_in_play(webtrap_buddy_id1))
	assert_true(player1.is_card_in_discards(TestCardId3))
...
func test_byakuya_ua_no_webtrap():
	position_players(player1, 3, player2, 6)

	assert_true(game_logic.do_character_action(player1, []))
	execute_strike(player1, player2, "uni_normal_sweep", "uni_normal_spike", [], [], false, true)
	validate_positions(player1, 3, player2, 6)
	validate_life(player1, 24, player2, 30)
	advance_turn(player2)

func test_byakuya_ua_webtrap_single():
	position_players(player1, 3, player2, 6)
	give_player_specific_card(player1, "byakuya_endlessnightmare", TestCardId3)
...
func test_byakuya_ua_webtrap_double():
	position_players(player1, 3, player2, 6)
	give_player_specific_card(player1, "byakuya_endlessnightmare", TestCardId3)
	give_player_specific_card(player1, "byakuya_becomeapartofme", TestCardId4)
	...
	assert_true(game_logic.do_choice(player1, 5))
	var webtrap_buddy_id1 = player1.get_buddy_id_for_boost(TestCardId3)
	assert_eq(player1.get_buddy_location(webtrap_buddy_id1), 6)
	assert_true(player1.is_card_in_continuous_boosts(TestCardId3))
	advance_turn(player2)
...
func test_byakuya_exceed_ua_no_ex():
	position_players(player1, 3, player2, 6)
	...
	player1.move_card_from_hand_to_deck(TestCardId5)

	assert_true(game_logic.do_character_action(player1, [player1.gauge[0].id, player1.gauge[1].id]))
	assert_true(game_logic.do_choice(player1, 0))
	assert_eq(len(player1.hand), 4)
	advance_turn(player2)

func test_byakuya_exceed_ua_ex_in_hand():
	position_players(player1, 3, player2, 6)
	player1.exceeded = true
	give_gauge(player1, 2)
	player1.hand = []
	give_player_specific_card(player1, "uni_normal_assault", TestCardId3)
	give_player_specific_card(player1, "uni_normal_grasp", TestCardId4)
	give_player_specific_card(player1, "uni_normal_assault", TestCardId5)
	player1.move_card_from_hand_to_deck(TestCardId4)
	player1.move_card_from_hand_to_deck(TestCardId5)
	...
	assert_true(game_logic.do_character_action(player1, [player1.gauge[0].id, player1.gauge[1].id]))
	assert_true(game_logic.do_choice(player1, 0))
	assert_true(game_logic.do_strike(player1, TestCardId3, false, TestCardId5))
	assert_true(game_logic.do_strike(player2, TestCardId2, false, -1))
	validate_positions(player1, 5, player2, 6)
	validate_life(player1, 30, player2, 24)
	advance_turn(player1)

func test_byakuya_exceed_ua_invalid_ex_in_hand():
	position_players(player1, 3, player2, 8)
	player1.exceeded = true
	give_gauge(player1, 2)
	player1.hand = []
	give_player_specific_card(player1, "uni_normal_assault", TestCardId3)
	give_player_specific_card(player1, "byakuya_endlessnightmare", TestCardId4)
	give_player_specific_card(player1, "byakuya_endlessnightmare", TestCardId5)
	...
	assert_true(game_logic.do_character_action(player1, [player1.gauge[0].id, player1.gauge[1].id]))
	assert_true(game_logic.do_choice(player1, 0))
	assert_true(game_logic.do_strike(player1, TestCardId4, false, TestCardId5))
	assert_true(game_logic.do_strike(player2, TestCardId2, false, -1))
	validate_positions(player1, 7, player2, 6)
	validate_life(player1, 30, player2, 24)
	advance_turn(player2)

func test_byakuya_exceed_ua_superior():
	position_players(player1, 3, player2, 6)
	player1.exceeded = true
	give_gauge(player1, 2)
...
func test_byakuya_caught_you_hit():
	position_players(player1, 3, player2, 7)

	execute_strike(player1, player2, "byakuya_caughtyou", "uni_normal_assault", [], [], false, false)
	validate_positions(player1, 3, player2, 7)
	validate_life(player1, 30, player2, 27)
	advance_turn(player1)

func test_byakuya_caught_you_miss():
	position_players(player1, 3, player2, 7)

	execute_strike(player1, player2, "byakuya_caughtyou", "uni_normal_dive", [], [], false, false)
	validate_positions(player1, 3, player2, 4)
	validate_life(player1, 25, player2, 30)
	advance_turn(player2)

func test_byakuya_caught_you_hit_speed_boost():
	position_players(player1, 3, player2, 7)

	execute_strike(player1, player2, "byakuya_caughtyou", "uni_normal_dive", [], [], false, true)
	validate_positions(player1, 3, player2, 7)
	validate_life(player1, 30, player2, 28)
	advance_turn(player1)

func test_byakuya_disrespect_opponent_initiates():
	position_players(player1, 5, player2, 6)
	give_player_specific_card(player1, "byakuya_caughtyou", TestCardId3)
...
func test_byakuya_howshallicookyou_no_reveals():
	position_players(player1, 3, player2, 5)

	execute_strike(player1, player2, "byakuya_howshallicookyou", "uni_normal_grasp", [], [], false, false)
	assert_true(game_logic.do_choose_to_discard(player1, []))
	validate_positions(player1, 3, player2, 5)
	validate_life(player1, 30, player2, 27)
	advance_turn(player2)

func test_byakuya_howshallicookyou_one_reveal():
	position_players(player1, 3, player2, 5)
...
func test_byakuya_howshallicookyou_many_reveal():
	position_players(player1, 3, player2, 5)
	give_player_specific_card(player1, "byakuya_minced", TestCardId3)
	give_player_specific_card(player1, "byakuya_minced", TestCardId4)
	give_player_specific_card(player1, "byakuya_minced", TestCardId5)
	give_player_specific_card(player1, "byakuya_minced", TestCardId6)

	execute_strike(player1, player2, "byakuya_howshallicookyou", "uni_normal_grasp", [], [], false, false)
	assert_true(game_logic.do_choose_to_discard(player1, [TestCardId3, TestCardId4, TestCardId5, TestCardId6]))
	validate_positions(player1, 3, player2, 2)
	validate_life(player1, 30, player2, 23)
	advance_turn(player2)

func test_byakuya_plant_cant_boost():
	position_players(player1, 3, player2, 7)
	player1.hand = []

	execute_strike(player1, player2, "byakuya_illplantitsomewhere", "uni_normal_grasp", [1, 0], [], false, false)
	validate_positions(player1, 3, player2, 6)
	validate_life(player1, 30, player2, 27)
	advance_turn(player2)

func test_byakuya_plant_play_boost():
	position_players(player1, 3, player2, 7)
	player1.hand = []
	give_player_specific_card(player1, "byakuya_endlessnightmare", TestCardId3)
...
func test_byakuya_plant_play_boost_stunned():
	position_players(player1, 3, player2, 7)
	player1.hand = []
	give_player_specific_card(player1, "byakuya_endlessnightmare", TestCardId3)

	execute_strike(player1, player2, "byakuya_illplantitsomewhere", "uni_normal_sweep", [1, 0], [], false, false)
	assert_true(game_logic.do_boost(player1, TestCardId3, []))
	assert_true(game_logic.do_choice(player1, 5))
	var webtrap_buddy_id = player1.get_buddy_id_for_boost(TestCardId3)
...
func test_byakuya_predator_no_menace_dont_play():
	position_players(player1, 3, player2, 7)
	player1.hand = []
...
func test_byakuya_menace_no_predator_dont_play():
	position_players(player1, 3, player2, 7)
	player1.hand = []
	give_player_specific_card(player1, "byakuya_minced", TestCardId3)
	give_player_specific_card(player1, "standard_normal_grasp", TestCardId4)
...
func test_byakuya_predator_no_menace_play():
	position_players(player1, 3, player2, 7)
	player1.hand = []
	give_player_specific_card(player1, "byakuya_orshredded", TestCardId3)
	give_player_specific_card(player1, "byakuya_minced", TestCardId4)
...
func test_byakuya_menace_no_predator_play():
	position_players(player1, 3, player2, 7)
	player1.hand = []
	give_player_specific_card(player1, "byakuya_minced", TestCardId3)
	give_player_specific_card(player1, "byakuya_orshredded", TestCardId4)
...
func test_byakuya_predator_with_menace():
	position_players(player1, 3, player2, 7)
	player1.hand = []
	give_player_specific_card(player1, "byakuya_orshredded", TestCardId3)
	give_player_specific_card(player1, "byakuya_minced", TestCardId4)
...
func test_byakuya_menace_with_predator():
	position_players(player1, 3, player2, 7)
	player1.hand = []
	give_player_specific_card(player1, "byakuya_minced", TestCardId3)
	give_player_specific_card(player1, "byakuya_orshredded", TestCardId4)
...
func test_byakuya_becomeapartofme_boost():
	position_players(player1, 3, player2, 6)
	give_gauge(player1, 4)

	execute_strike(player1, player2, "byakuya_becomeapartofme", "uni_normal_grasp", [3, 0, 3], [], false, false)
	var webtrap_buddy_id = player1.get_buddy_id_for_boost(TestCardId1)

	assert_eq(player1.get_buddy_location(webtrap_buddy_id), 4)
	assert_true(player1.is_card_in_continuous_boosts(TestCardId1))
	validate_positions(player1, 3, player2, 4)
	validate_life(player1, 30, player2, 24)
	advance_turn(player2)

func test_byakuya_becomeapartofme_boost_stunned():
	position_players(player1, 3, player2, 6)
	give_gauge(player1, 4)

	execute_strike(player1, player2, "byakuya_becomeapartofme", "uni_normal_sweep", [3, 0, 3], [], false, false)
	var webtrap_buddy_id = player1.get_buddy_id_for_boost(TestCardId1)
...
func test_byakuya_endlessnightmare_miss():
	position_players(player1, 3, player2, 5)
	give_gauge(player1, 2)

	execute_strike(player1, player2, "byakuya_endlessnightmare", "uni_normal_grasp", [], [], false, false)
...
func test_byakuya_endlessnightmare_dont_boost():
	position_players(player1, 3, player2, 4)
	give_gauge(player1, 2)

	execute_strike(player1, player2, "byakuya_endlessnightmare", "uni_normal_sweep", [1], [], false, false)
...
func test_byakuya_endlessnightmare_boost():
	position_players(player1, 3, player2, 4)
	give_gauge(player1, 2)

	execute_strike(player1, player2, "byakuya_endlessnightmare", "uni_normal_sweep", [0, 3], [], false, false)
	var webtrap_buddy_id = player1.get_buddy_id_for_boost(TestCardId1)
...
func test_byakuya_endlessnightmare_boost_stunned():
	position_players(player1, 3, player2, 4)
	give_gauge(player1, 2)

	execute_strike(player1, player2, "byakuya_endlessnightmare", "uni_normal_focus", [0, 3], [], false, true)
	var webtrap_buddy_id = player1.get_buddy_id_for_boost(TestCardId1)
...
# TODO: Unclear what should happen in these tests; currently assumes that active player's web resolves first
...
func test_byakuya_webtrap_mirror_stacked_forced_movement():
