...
var default_deck = CardDefinitions.get_deck_from_str_id("orie")
...
func test_orie_ua_normal():
	position_players(player1, 3, player2, 6)

	assert_true(game_logic.do_character_action(player1, []))
	execute_strike(player1, player2, "uni_normal_sweep", "uni_normal_sweep", [], [], false, false)
	validate_positions(player1, 3, player2, 6)
	validate_life(player1, 24, player2, 24)
	advance_turn(player2)

func test_orie_ua_special():
	position_players(player1, 3, player2, 6)

	assert_true(game_logic.do_character_action(player1, []))
	execute_strike(player1, player2, "orie_succession", "uni_normal_sweep", [], [], false, false)
	validate_positions(player1, 3, player2, 2)
	validate_life(player1, 26, player2, 27)
	advance_turn(player1)

func test_orie_ua_ultra():
	position_players(player1, 3, player2, 6)
	give_gauge(player1, 3)

	assert_true(game_logic.do_character_action(player1, []))
	execute_strike(player1, player2, "orie_luminousembrace", "uni_normal_focus", [], [], false, false)
	validate_positions(player1, 5, player2, 6)
	validate_life(player1, 28, player2, 25)
	advance_turn(player1)

func test_orie_exceed_ua():
	...
	assert_true(game_logic.do_character_action(player1, [TestCardId3]))
...
func test_orie_exceed_ua_ultra():
	...
	assert_true(game_logic.do_character_action(player1, [TestCardId3]))
	execute_strike(player1, player2, "orie_restinpeace", "uni_normal_assault", [], [], false, false)
	validate_positions(player1, 4, player2, 5)
	validate_life(player1, 30, player2, 18)
	advance_turn(player2)

func test_orie_exceed_ua_sweep():
	position_players(player1, 4, player2, 6)
	player1.exceed()
	player1.hand = []
	give_gauge(player1, 1)
	...
	assert_true(game_logic.do_character_action(player1, [TestCardId3]))
	execute_strike(player1, player2, "orie_restinpeace", "uni_normal_sweep", [], [], false, false)
	validate_positions(player1, 4, player2, 6)
	validate_life(player1, 30, player2, 20)
	advance_turn(player2)

func test_orie_fifth_executor():
	position_players(player1, 4, player2, 6)
	give_player_specific_card(player1, "orie_luminousembrace", TestCardId4)

	assert_true(game_logic.do_boost(player1, TestCardId4, []))
	execute_strike(player1, player2, "uni_normal_cross", "uni_normal_dive", [], [], true, false)
	validate_positions(player1, 1, player2, 6)
	validate_life(player1, 30, player2, 25)
	assert_true(player1.is_card_in_gauge(TestCardId4))
	advance_turn(player2)

func test_orie_the_ruler_advance():
	position_players(player1, 3, player2, 7)
	player1.hand = []
	give_player_specific_card(player1, "orie_restinpeace", TestCardId3)

	assert_true(game_logic.do_boost(player1, TestCardId3, []))
	assert_eq(len(player1.hand), 2)
	advance_turn(player2)

	execute_strike(player1, player2, "uni_normal_dive", "uni_normal_dive", [], [], false, false)
	validate_positions(player1, 8, player2, 7)
	validate_life(player1, 30, player2, 25)
	advance_turn(player2)

func test_orie_the_ruler_retreat():
	...
	execute_strike(player1, player2, "uni_normal_cross", "uni_normal_dive", [], [], false, false)
	validate_positions(player1, 2, player2, 7)
	validate_life(player1, 30, player2, 27)
	advance_turn(player2)

func test_orie_the_ruler_close():
	position_players(player1, 3, player2, 7)
	player1.hand = []
	give_player_specific_card(player1, "orie_restinpeace", TestCardId3)
