...
var default_deck = CardDefinitions.get_deck_from_str_id("vega")
...
func test_vega_ua_normal():
	...
	execute_strike(player1, player2, "standard_normal_sweep", "standard_normal_sweep", [], [], false, false, [], [], 0, false, false)
...
func test_vega_ua_special():
	position_players(player1, 1, player2, 2)
	execute_strike(player1, player2, "vega_scarletterror", "standard_normal_sweep", [], [], false, false, [], [], 0, false, false)
	validate_positions(player1, 1, player2, 2)
...
func test_vega_ua_exceeded_special():
	position_players(player1, 1, player2, 2)
	player1.exceeded = true
	execute_strike(player1, player2, "vega_scarletterror", "standard_normal_assault", [], [], false, false, [], [], 0, false, false)
	validate_positions(player1, 1, player2, 2)
...
func test_vega_bloodyhigh_2_spaces_playerright():
	...
	execute_strike(player1, player2, "vega_bloodyhighclaw", "standard_normal_sweep", [], [], false, false, [player1.gauge[0].id], [], 0, true, false)
	# Move up to 8
...
func test_vega_scarletterror_boost():
	...
	validate_positions(player1, 5, player2, 6)
	give_gauge(player1, 4)
	execute_strike(player1, player2, "vega_bloodyhighclaw", "standard_normal_focus", [], [], false, false, [player1.gauge[0].id], [], 0, true, false)
	# Move up to 8
	assert_true(game_logic.do_choice(player1, 0))
	validate_positions(player1, 5, player2, 6)
	validate_life(player1, 30, player2, 23)
...
func test_vega_scarletterror_boost_exceeded():
	...
	validate_positions(player1, 5, player2, 6)
	give_gauge(player1, 4)
	execute_strike(player1, player2, "vega_bloodyhighclaw", "standard_normal_cross", [], [], false, true, [player1.gauge[0].id], [], 0, true, false)
	# Move up to 8
	assert_true(game_logic.do_choice(player1, 0))
	validate_positions(player1, 5, player2, 6)
...
func test_vega_skyhighclaw_boost_miss():
	...
	player1.draw(3)
	give_player_specific_card(player1, "vega_skyhighclaw", TestCardId2)
