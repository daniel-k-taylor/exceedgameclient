...
var default_deck = CardDefinitions.get_deck_from_str_id("chunli")
...
func test_chunli_headstomp():
	position_players(player1, 3, player2, 5)
	give_gauge(player1, 1)
	assert_eq(player1.hand.size(), 5)
	execute_strike(player1, player2, "chunli_headstomp", "standard_normal_assault", [], [], false, false, [player1.gauge[0].id], [], 0, true, false)
	validate_positions(player1, 7, player2, 5)
	validate_life(player1, 30, player2, 24)
	assert_eq(player1.hand.size(), 6)
	advance_turn(player2)

func test_chunli_headstomp_miss():
...
func test_chunli_headstomp_miss_even_with_boost():
...
func test_chunli_spinning_bird_nopass():
	position_players(player1, 1, player2, 5)
	execute_strike(player1, player2, "chunli_spinningbirdkick", "standard_normal_dive", [], [], false, false, [], [], 0, false, false)
	validate_positions(player1, 4, player2, 5)
	validate_life(player1, 30, player2, 25)
	advance_turn(player2)

func test_chunli_spinning_bird_pass():
	position_players(player1, 2, player2, 5)
	execute_strike(player1, player2, "chunli_spinningbirdkick", "standard_normal_dive", [], [], false, false, [], [], 0, false, false)
	assert_true(game_logic.do_choice(player1, 0)) # Push 2
	validate_positions(player1, 6, player2, 3)
	validate_life(player1, 30, player2, 25)
	advance_turn(player2)

func test_chunli_spinning_bird_pass_miss():
...
func test_chunli_ultra_parry_all():
	position_players(player1, 4, player2, 5)
...
func test_chunli_ultra_parry_choose():
	position_players(player1, 4, player2, 5)
	player2.discard_hand()
