...
func test_custom_gauge_reduction_per_boost_in_play():
	...
	# The validation I need is to check that only 2 cards are in P1 gauge right now - the attack, and one of the blocks.
	# No clue what the code for that would be though.
	advance_turn(player1) 
